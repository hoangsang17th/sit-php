        ...
        <div class="row align-items-center position-relative" style="z-index: 1;">
            <div class="col-lg-6 col-md-12">
                <div class="title-heading mt-4 text-center text-lg-left">
                    <h1 class="heading mb-2 title-dark text-white">Sản phẩm tốt nhất cho cuộc sống của bạn</h1>
                    <p class="para-desc text-white-50">Mỗi sản phẩm đều giúp bạn xây dựng một nền tảng vững chắc cho cuộc sống chất lượng hơn.<br><span class="font-weight-bold">- Hoàng Sang -</span> </p>
                </div>
            </div>
            <div class="col-lg-6 col-md-12">
                <img src="images\software\SITM.png" class="w-100" alt="">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-center">
            <div class="col-12 text-center">
                <div class="section-title mb-4 pb-2">
                    <h4 class="title mb-4">Chúng tôi làm gì?</h4>
                    <p class="text-muted para-desc mx-auto mb-0">Tại <span class="text-primary font-weight-bold">SIT</span>, chúng tôi cung cấp các dịch vụ với hầu hết các nhu cầu của người dùng.</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 col-12 mt-5">
                <div class="features text-center">
                    ...
                    <div class="content mt-4">
                        <h4 class="title-2">Phân tích & Thiết kế</h4>
                        <p class="text-muted mb-0">Từ Hệ thống phần mềm đến các sản phẩm đồ họa chất lượng cáo.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-12 mt-5">
                <div class="features text-center">
                    ...
                    <div class="content mt-4">
                        <h4 class="title-2">Quảng cáo</h4>
                        <p class="text-muted mb-0">Cung cấp dịch vụ quảng cáo tối ưu khiến doanh thu của bạn tăng đột biến.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-12 mt-5">
                <div class="features text-center">
                    ...
                    <div class="content mt-4">
                        <h4 class="title-2">Bản quyền sáng chế</h4>
                        <p class="text-muted mb-0">Chúng tôi sẽ giúp bạn hoàn tất các thủ tục rắc rối để đăng ký bằng sáng chế.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-12 mt-5">
                <div class="features text-center">
                    ...
                    <div class="content mt-4">
                        <h4 class="title-2">Hỗ trợ 24/7</h4>
                        <p class="text-muted mb-0">Tự hào là 1 Google thứ 2, chúng tôi có tát cả các chuyên gia về mọi lĩnh vực.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-12 mt-5">
                <div class="features text-center">
                    ...
                    <div class="content mt-4">
                        <h4 class="title-2">Báo cáo hằng ngày</h4>
                        <p class="text-muted mb-0">SIT To Do có thể kiểm soát công việc của bạn thật tốt.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-12 mt-5">
...
<div class="position-relative">
    <div class="shape overflow-hidden text-footer">
        <svg viewBox="0 0 2880 88" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 48H1437.5H2880V0H2160C1442.5 52 720 0 720 0H0V48Z" fill="currentColor"></path>
        </svg>
    </div>
</div>
